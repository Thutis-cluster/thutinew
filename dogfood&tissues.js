...
const jsonFile = 'dogfood&tissues-products.json'; // e.g. 'vegetables.json', 'chickenproducts.json'
...
// Attach click event to all .listProduct containers (Dog Food and Tissues)
...
const renderCategorizedProducts = () => {
  const categorySections = {
    "Dog Food": document.getElementById("section-DogFood"),
    "Tissues": document.getElementById("section-Tissues")
  };

  // Clear all sections
  Object.values(categorySections).forEach(section => section.innerHTML = '');

  // Define keyword-based category logic
  const categories = [
    { name: "Dog Food", keywords: ["dog", "puppy", "pet"] },
    { name: "Tissues", keywords: ["tissue", "kleenex", "paper"] }
  ];
