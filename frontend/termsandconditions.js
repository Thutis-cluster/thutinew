...
document.getElementById('homepageSearchForm')?.addEventListener('submit', function (e) {
    ...
    if (window.location.pathname.includes("termsandconditions.html")) {
...
// 🔍 Live Search for Terms and Conditions Page
document.addEventListener("DOMContentLoaded", () => {
    if (!window.location.pathname.includes("termsandconditions.html")) return;
